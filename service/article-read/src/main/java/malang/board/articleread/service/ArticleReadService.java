package malang.board.articleread.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import malang.board.articleread.client.ArticleClient;
import malang.board.articleread.client.CommentClient;
import malang.board.articleread.client.LikeClient;
import malang.board.articleread.client.ViewClient;
...
import malang.board.articleread.service.event.handler.EventHandler;
...
public class ArticleReadService {
    ...
    private List<ArticleReadResponse> readAll(List<Long> articleIds) {
        ...
        return articleIds.stream()
                ...
                .map(articleQueryModel -> ArticleReadResponse.from(articleQueryModel, viewClient.count(articleQueryModel.getArticleId())))
                .toList();
    }
    ...
    private Optional<ArticleQueryModel> fetch(Long articleId) {
        ...
        articleQueryModelOptional.ifPresent(articleQueryModel ->
                articleQueryModelRepository.create(articleQueryModel, Duration.ofDays(1L))
        );
